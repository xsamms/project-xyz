...
const createInquiry = catchAsync(async (req, res) => {
  const { userId,talentId, agencyId, managerId, agencyManagerId, fullName, stageName, email, phoneNumber, type, subject, message, attachment, eventType, eventVenue, eventCity, eventCountry, eventDate, eventTime} = req.body;
  const inquiry = await inquiryService.createInquiry( userId, talentId, agencyId, managerId, agencyManagerId, fullName, stageName, email, phoneNumber, type, subject, message, attachment, eventType, eventVenue, eventCity, eventCountry, eventDate, eventTime);
